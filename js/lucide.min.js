/**
 * Lucide Icons Fallback for Keyquest Admin Panel
 * This is a lightweight fallback that provides the essential icons needed
 * Save this file as: js/lucide.min.js
 */

(function(global) {
    'use strict';

    // Icon SVG definitions - essential icons for your admin panel
    const icons = {
        'building-2': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"/><path d="M6 12H4a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"/><path d="M18 9h2a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2h-2"/><path d="M10 6h4"/><path d="M10 10h4"/><path d="M10 14h4"/><path d="M10 18h4"/></svg>',
        ...
        'users': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="m22 21-2-2"/><path d="M16 8a4 4 0 0 0-4-4"/></svg>',
        
        'help-circle': '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m9 9 3-3 3 3"/><path d="m9 15 3 3 3-3"/></svg>',
        ...
        createIcons: function(options = {}) {
            try {
                ...
                iconElements.forEach(element => {
                    ...
                    if (icons[iconName]) {
                        // Replace the element content with the SVG
                        element.innerHTML = icons[iconName];
                        
                        // Apply any custom attributes
                        const svg = element.querySelector('svg');
                        if (svg) {
                            // Copy any custom width/height from the element
                        ...
                        console.warn(`Lucide icon "${iconName}" not found in fallback set`);
                        // Fallback to a generic icon
                        element.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>';
                    }
                });
                
                console.log(`Lucide fallback: Created ${iconElements.length} icons`);
            } catch (error) {
                console.error('Lucide fallback error:', error);
            }
        },
        
        // Add individual icon access
        icons: icons
    };

    // Make lucide available globally
    if (typeof exports !== 'undefined') {
        exports.lucide = lucide;
    } else {
    ...
    console.log('Lucide fallback library loaded successfully');
